...
- **User_ID** – Unique identifier for each applicant  
- **Submission_Time** – Time of application submission  
- **Age** – Age of applicant  
- **CGPA** – Academic performance score  
- **Submissions_Per_Minute** – Frequency of submissions  
